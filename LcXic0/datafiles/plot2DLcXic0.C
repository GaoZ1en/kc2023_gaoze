...
void plot2DLcXic0()
{
   ...
   //TCut Xic0Cut("Xic_M<2580 && Xic_M>2380");
   ...
   //***************************** 2D ******************************
   TH2F *h_2D = new TH2F("h_2D","h_2D",50,2210,2360,50,2380,2580);
   ...
   h_2D->GetYaxis()->SetTitle("#it{M}(#it{#Xi_{c}^{0}}) [MeV/c^{2}]");
   ...
   c_2D->SaveAs("fitplot3DLcXic0.pdf");
   c_2D->SaveAs("fitplot3DLcXic0.png");
   c_2D->SaveAs("fitplot3DLcXic0.eps");
} 
