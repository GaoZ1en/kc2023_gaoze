void draw_Mag(){
  ...
  TH1F *h_MagUp = new TH1F("h_MagUp","h_MagUp",100,4757,6757);
  tree_MagUp->Project("h_MagUp","C_M-Lc_M-Xic_M+2286.46+2470.44","nsig_sw");
  h_MagUp->Draw();
  ...
  TH1F *h_MagDown = new TH1F("h_MagDown","h_MagDown",100,4757,6757);
  tree_MagDown->Project("h_MagDown","C_M-Lc_M-Xic_M+2286.46+2470.44","nsig_sw");
  h_MagDown->Draw();
