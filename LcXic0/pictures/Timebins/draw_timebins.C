void draw_timebins(){
  ...
  TH1F *h_2016 = new TH1F("h_2016","h_2016",100,4757,6757);
  tree_2016->Project("h_2016","C_M-Lc_M-Xic_M+2286.46+2470.44","nsig_sw");
  h_2016->Draw();
  ...
  TH1F *h_2017 = new TH1F("h_2017","h_2017",100,4757,6757);
  tree_2017->Project("h_2017","C_M-Lc_M-Xic_M+2286.46+2470.44","nsig_sw");
  h_2017->Draw();
  ...
  TH1F *h_2018 = new TH1F("h_2018","h_2018",100,4757,6757);
  tree_2018->Project("h_2018","C_M-Lc_M-Xic_M+2286.46+2470.44","nsig_sw");
  h_2018->Draw();
