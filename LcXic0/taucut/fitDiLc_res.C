...
void fitDiLc_res()
{
   ...
   chain->AddFile("/home/Koishi/DiLc/datafiles/XiccTuple_sw_corrected.root");
   ...
   RooRealVar *Nsig2 = new RooRealVar("nsig2","Number of signal events",1000,0,5000);
   RooRealVar *Nsig3 = new RooRealVar("nsig3","Number of signal events",1000,0,5000);
   RooRealVar *Nsig4 = new RooRealVar("nsig4","Number of signal events",1000,0,5000);
   RooRealVar *Nsig5 = new RooRealVar("nsig5","Number of signal events",1000,0,5000);
   RooRealVar *Nsig6 = new RooRealVar("nsig6","Number of signal events",1000,0,5000);
   RooRealVar *Nsig7 = new RooRealVar("nsig7","Number of signal events",1000,0,5000);
   RooRealVar *Nbkg = new RooRealVar("nbkg","Number of bkg",1000,0,5000);
