...
void fitDiLc_res()
{
   ...
   RooRealVar *mean2 = new RooRealVar("#mu2","mean2",4598.4,4575,4625);
   //mean2->setConstant(true);
   RooRealVar *width2 = new RooRealVar("#width2","width2",26.862,0,50);
   ...
   RooRealVar *mean3 = new RooRealVar("#mu3","mean3",4657.2,4625,4675);
   //mean3->setConstant(true);
   RooRealVar *width3 = new RooRealVar("#width3","width3",116.05,0,150);
   //width3->setConstant(true);
   ...
   RooRealVar *mean4 = new RooRealVar("#mu4","mean4",4764.6,4740,4840);
   //mean4->setConstant(true);
   RooRealVar *width4 = new RooRealVar("#width4","width4",119.97,0,120);
   //width4->setConstant(true);
   ...
   RooRealVar *mean5 = new RooRealVar("#mu5","mean5",4905.6,4850,4950);
   //mean5->setConstant(true);
   RooRealVar *width5 = new RooRealVar("#width5","width5",48.795,0,200);
   //width5->setConstant(true);
   ...
   RooRealVar *mean7 = new RooRealVar("#mu7","mean7",5024.8,4950,5050);
   //mean7->setConstant(true);
   RooRealVar *width7 = new RooRealVar("#width7","width7",150,0,150);
   //width7->setConstant(true);
   ...
   TH1F *h_bb = new TH1F("h_bb","h_bb",75,4575,6075);
   TH1F *h_bs = new TH1F("h_bs","h_bs",75,4575,6075);
   TH1F *h_comb = new TH1F("h_comb","h_comb",75,4575,4575);
   TTree *tree_bkg = chain->CopyTree(LcCut);
   tree_bkg->Project("h_bb","C_M-Lc_M-LcBar_M+2286.99*2","nbb_sw");
   tree_bkg->Project("h_bs","C_M-Lc_M-LcBar_M+2286.99*2","nbs_sw");
   ...
   RooRealVar *Nsig2 = new RooRealVar("nsig2","Number of signal events",1607.2,0,10000);
   RooRealVar *Nsig3 = new RooRealVar("nsig3","Number of signal events",4150.0,0,10000);
   RooRealVar *Nsig4 = new RooRealVar("nsig4","Number of signal events",598.75,0,10000);
   RooRealVar *Nsig5 = new RooRealVar("nsig5","Number of signal events",297.54,0,10000);
   RooRealVar *Nsig6 = new RooRealVar("nsig6","Number of signal events",49.517,0,10000);
   RooRealVar *Nsig7 = new RooRealVar("nsig7","Number of signal events",602.31,0,10000);
   RooRealVar *Nbkg = new RooRealVar("nbkg","Number of bkg",1401,0,10000);
   Nbkg->setConstant(true);
   RooRealVar *Nbkg_comb = new RooRealVar("nbkg_comb","Number of bkg_comb",14160,0,20000);

   // **** total pdf and fit ****
   RooAbsPdf *total= new RooAddPdf("total","sum of signal and background PDF's",RooArgList(*sig2,*sig3,*sig4,*sig5,*sig6,*sig7,*bkg,*bkg_comb),RooArgList(*Nsig2,*Nsig3,*Nsig4,*Nsig5,*Nsig6,*Nsig7,*Nbkg,*Nbkg_comb));
