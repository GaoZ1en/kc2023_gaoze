...
void fitDiLc_res()
{
   ...
   // **** interference ****
   RooRealVar *r1 = new RooRealVar("r1","rate 1",1,0,10);
   RooRealVar *r3 = new RooRealVar("r3","rate 1",1,0,10);
   RooRealVar *phi1 = new RooRealVar("phi1","phi 1",0,0,6.28);
   RooRealVar *phi3 = new RooRealVar("phi3","phi 3",0,0,6.28);

   RooFormulaVar *r11 = new RooFormulaVar("r11","r11","@0*@0",RooArgSet(*r1));
   RooRealVar *r22 = new RooRealVar("r22","r22",1);r22->setConstant(true);
   RooFormulaVar *r33 = new RooFormulaVar("r33","r33","@0*@0",RooArgSet(*r1));
   RooFormulaVar *r12 = new RooFormulaVar("r12","r12","2*@0*cos(@1)",RooArgSet(*r1,*phi1));
   RooFormulaVar *r23 = new RooFormulaVar("r23","r23","2*@0*cos(@1)",RooArgSet(*r3,*phi3));
   RooFormulaVar *r31 = new RooFormulaVar("r31","r31","2*@0*@1*cos(@2-@3)",RooArgSet(*r3,*r1,*phi3,*phi1));

   RooAbsPdf *sig12 = new RooProdPdf("sig12","sig12",RooArgSet(*sig3,*sig4));
   RooAbsPdf *sig23 = new RooProdPdf("sig23","sig23",RooArgSet(*sig4,*sig5));
   RooAbsPdf *sig31 = new RooProdPdf("sig31","sig31",RooArgSet(*sig5,*sig3));
   RooAbsPdf *sig11 = new RooProdPdf("sig11","sig11",RooArgSet(*sig3,*sig3));
   RooAbsPdf *sig22 = new RooProdPdf("sig22","sig22",RooArgSet(*sig4,*sig4));
   RooAbsPdf *sig33 = new RooProdPdf("sig33","sig33",RooArgSet(*sig5,*sig5));

   RooAbsPdf *sig_int = new RooAddPdf("sig_int","interference of signals",RooArgList(*sig11,*sig22,*sig33,*sig12,*sig23,*sig31),RooArgList(*r11,*r22,*r33,*r12,*r23,*r31));
   ...
   RooRealVar *Nsig_int = new RooRealVar("nsig_int","Number of interference term",1000,0,10000);

   // **** total pdf and fit ****
   RooAbsPdf *total= new RooAddPdf("total","sum of signal and background PDF's",RooArgList(*sig2,*sig3,*sig4,*sig5,*sig6,*sig7,*bkg,*sig_int),RooArgList(*Nsig2,*Nsig3,*Nsig4,*Nsig5,*Nsig6,*Nsig7,*Nbkg,*Nsig_int));
   ...
   total->plotOn(mframe,Components(*sig_int),LineColor(8),LineStyle(kDashed),Name("interference"));
   ...
   legend->AddEntry("interference","interference","l");
