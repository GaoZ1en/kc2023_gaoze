void drawCMass()
{
  ...
  chain->AddFile("/home/Koishi/Projects/kc2023/DiLc/feeddown/Bu2LcLcK/Bu2LcLcK_sw.root");
  ...
  MyCan->Print("Bu2LcLcK.png");
  MyCan->Print("Bu2LcLcK.pdf");
  MyCan->Print("Bu2LcLcK.eps");
}
