...
void fitDiLc()
{
   ...
   chain->Add("/home/Koishi/Projects/kc2023/DiLc/feeddown/Bu2LcLcK/Bu2LcLcK_Sim.root/DecayTree");
   ...
   params->writeToFile("params_Bu2LcLcK.txt");
   ...
   //************************* sweight ***************************
   TFile* file = new TFile("Bu2LcLcK_sw.root","recreate"); 
