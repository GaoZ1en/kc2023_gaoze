...
void fitDiLc_res()
{
   ...
   chain->AddFile("/home/Koishi/Projects/kc2023/DiLc/datafiles/XiccTuple_sw_corrected.root");

   RooRealVar *m = new RooRealVar("C_M_corrected","M(#Lambda_{c}^{+}#bar{#Lambda}_{c}^{#minus})",4575,6075,"MeV/c^{2}");
   RooRealVar *nsig_sw = new RooRealVar("nsig_sw","signal weight",-2,2);

   RooDataSet *data = new RooDataSet("data","dataset with m", chain->CopyTree(LcCut&&TauCut),RooArgSet(*m,*nsig_sw),nullptr,"nsig_sw");
   ...
   RooRealVar *width4 = new RooRealVar("#width4","width4",60,1,100);
   ...
   RooRealVar *width5 = new RooRealVar("#width5","width5",40,1,100);
   ...
   TChain *chain_Bu2LcLcK = new TChain("DecayTree");
   chain_Bu2LcLcK->AddFile("/home/Koishi/Projects/kc2023/DiLc/feeddown/Bu2LcLcK/Bu2LcLcK_sw.root");
   TH1F *h_Bu2LcLcK = new TH1F("h_Bu2LcLcK","h_Bu2LcLcK",150,4575,6075);
   TTree *tree_Bu2LcLcK = chain_Bu2LcLcK->CopyTree(LcCut&&TauCut);
   tree_Bu2LcLcK->Project("h_Bu2LcLcK","C_M-Lc_M-LcBar_M+2286.99*2","nsig_sw");
   RooDataHist *data_Bu2LcLcK = new RooDataHist("data_Bu2LcLcK","dataset with m", *m, h_Bu2LcLcK);
   RooHistPdf *sig_Bu2LcLcK = new RooHistPdf("sig_Bu2LcLcK","sig_Bu2LcLcK",*m,*data_Bu2LcLcK);

   TChain *chain_Bu2LcLcPi = new TChain("DecayTree");
   chain_Bu2LcLcPi->AddFile("/home/Koishi/Projects/kc2023/DiLc/feeddown/Bu2LcLcPi/Bu2LcLcPi_sw.root");
   TH1F *h_Bu2LcLcPi = new TH1F("h_Bu2LcLcPi","h_Bu2LcLcPi",150,4575,6075);
   TTree *tree_Bu2LcLcPi = chain_Bu2LcLcPi->CopyTree(LcCut&&TauCut);
   tree_Bu2LcLcPi->Project("h_Bu2LcLcPi","C_M-Lc_M-LcBar_M+2286.99*2","nsig_sw");
   RooDataHist *data_Bu2LcLcPi = new RooDataHist("data_Bu2LcLcPi","dataset with m", *m, h_Bu2LcLcPi);
   RooHistPdf *sig_Bu2LcLcPi = new RooHistPdf("sig_Bu2LcLcPi","sig_Bu2LcLcPi",*m,*data_Bu2LcLcPi);

   TChain *chain_Bd2LcLcKS0 = new TChain("DecayTree");
   chain_Bd2LcLcKS0->AddFile("/home/Koishi/Projects/kc2023/DiLc/feeddown/Bd2LcLcKS0/Bd2LcLcKS0_sw.root");
   TH1F *h_Bd2LcLcKS0 = new TH1F("h_Bd2LcLcKS0","h_Bd2LcLcKS0",150,4575,6075);
   TTree *tree_Bd2LcLcKS0 = chain_Bd2LcLcKS0->CopyTree(LcCut&&TauCut);
   tree_Bd2LcLcKS0->Project("h_Bd2LcLcKS0","C_M-Lc_M-LcBar_M+2286.99*2","nsig_sw");
   RooDataHist *data_Bd2LcLcKS0 = new RooDataHist("data_Bd2LcLcKS0","dataset with m", *m, h_Bd2LcLcKS0);
   RooHistPdf *sig_Bd2LcLcKS0 = new RooHistPdf("sig_Bd2LcLcKS0","sig_Bd2LcLcKS0",*m,*data_Bd2LcLcKS0);

   TChain *chain_Lb2LcLcn = new TChain("DecayTree");
   chain_Lb2LcLcn->AddFile("/home/Koishi/Projects/kc2023/DiLc/feeddown/Lb2LcLcn/Lb2LcLcn_sw.root");
   TH1F *h_Lb2LcLcn = new TH1F("h_Lb2LcLcn","h_Lb2LcLcn",150,4575,6075);
   TTree *tree_Lb2LcLcn = chain_Lb2LcLcn->CopyTree(LcCut&&TauCut);
   tree_Lb2LcLcn->Project("h_Lb2LcLcn","C_M-Lc_M-LcBar_M+2286.99*2","nsig_sw");
   RooDataHist *data_Lb2LcLcn = new RooDataHist("data_Lb2LcLcn","dataset with m", *m, h_Lb2LcLcn);
   RooHistPdf *sig_Lb2LcLcn = new RooHistPdf("sig_Lb2LcLcn","sig_Lb2LcLcn",*m,*data_Lb2LcLcn);
   ...
   RooRealVar *Nsig_Bu2LcLcK   = new RooRealVar("nsig_Bu2LcLcK  ","Number of signal events",5000,0,10000);
   RooRealVar *Nsig_Bu2LcLcPi  = new RooRealVar("nsig_Bu2LcLcPi ","Number of signal events",5000,0,10000);
   RooRealVar *Nsig_Bd2LcLcKS0 = new RooRealVar("nsig_Bd2LcLcKS0","Number of signal events",5000,0,10000);
   RooRealVar *Nsig_Lb2LcLcn   = new RooRealVar("nsig_Lb2LcLcn  ","Number of signal events",5000,0,10000);
   RooRealVar *Nbkg = new RooRealVar("nbkg","Number of bkg",1000,0,10000);

   // **** total pdf and fit ****
   RooAbsPdf *total= new RooAddPdf("total","sum of signal and background PDF's",RooArgList(*sig2/*,*sig3,*sig4,*sig5,*sig6,*sig7,*/,*sig_Bu2LcLcK,*sig_Bu2LcLcPi,*sig_Bd2LcLcKS0,*sig_Lb2LcLcn,*bkg),RooArgList(*Nsig2/*,*Nsig3,*Nsig4,*Nsig5,*Nsig6,*Nsig7,*/,*Nsig_Bu2LcLcK,*Nsig_Bu2LcLcPi,*Nsig_Bd2LcLcKS0,*Nsig_Lb2LcLcn,*Nbkg));
   RooFitResult *fitres = total->fitTo(*data, Minos(kTRUE), Extended(kTRUE));

   RooArgSet *params = total->getParameters(data);
   params->writeToFile("params_feeddown.txt");
   ...
   total->plotOn(mframe,Components(*sig_Bu2LcLcK  ),LineColor(2),LineStyle(kDashed),Name("Bu2LcLcK  "));
   total->plotOn(mframe,Components(*sig_Bu2LcLcPi ),LineColor(3),LineStyle(kDashed),Name("Bu2LcLcPi "));
   total->plotOn(mframe,Components(*sig_Bd2LcLcKS0),LineColor(4),LineStyle(kDashed),Name("Bd2LcLcKS0"));
   total->plotOn(mframe,Components(*sig_Lb2LcLcn  ),LineColor(7),LineStyle(kDashed),Name("Lb2LcLcn  "));
   ...
   legend->AddEntry("Bu2LcLcK  ","Bu2LcLcK  ","l");
   legend->AddEntry("Bu2LcLcPi ","Bu2LcLcPi ","l");
   legend->AddEntry("Bd2LcLcKS0","Bd2LcLcKS0","l");
   legend->AddEntry("Lb2LcLcn  ","Lb2LcLcn  ","l");
