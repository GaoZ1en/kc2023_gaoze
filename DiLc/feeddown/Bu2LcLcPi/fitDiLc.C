...
void fitDiLc()
{
   ...
   chain->Add("/home/Koishi/Projects/kc2023/DiLc/feeddown/Bu2LcLcPi/Bu2LcLcPi_Sim.root/DecayTree");
   ...
   params->writeToFile("params_Bu2LcLcPi.txt");
   ...
   //************************* sweight ***************************
   TFile* file = new TFile("Bu2LcLcPi_sw.root","recreate"); 
