void drawCMass()
{
  ...
  chain->AddFile("/home/Koishi/Projects/kc2023/DiLc/feeddown/Bu2LcLcPi/Bu2LcLcPi_sw.root");
  ...
  MyCan->Print("Bu2LcLcPi.png");
  MyCan->Print("Bu2LcLcPi.pdf");
  MyCan->Print("Bu2LcLcPi.eps");
}
