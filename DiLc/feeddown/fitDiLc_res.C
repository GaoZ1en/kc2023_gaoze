...
void fitDiLc_res()
{
   ...
   TTree *tree_Bu2LcLcK = chain_Bu2LcLcK->CopyTree(LcCut);
   ...
   TTree *tree_Bu2LcLcPi = chain_Bu2LcLcPi->CopyTree(LcCut);
   ...
   TTree *tree_Bd2LcLcKS0 = chain_Bd2LcLcKS0->CopyTree(LcCut);
   ...
   TTree *tree_Lb2LcLcn = chain_Lb2LcLcn->CopyTree(LcCut);
   ...
   total->plotOn(mframe,Components(*sig_Bu2LcLcK  ),LineColor(10),LineStyle(kDashed),Name("Bu2LcLcK  "));
   total->plotOn(mframe,Components(*sig_Bu2LcLcPi ),LineColor(11),LineStyle(kDashed),Name("Bu2LcLcPi "));
   total->plotOn(mframe,Components(*sig_Bd2LcLcKS0),LineColor(12),LineStyle(kDashed),Name("Bd2LcLcKS0"));
   total->plotOn(mframe,Components(*sig_Lb2LcLcn  ),LineColor(13),LineStyle(kDashed),Name("Lb2LcLcn  "));
