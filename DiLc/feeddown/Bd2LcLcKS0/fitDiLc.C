...
void fitDiLc()
{
   ...
   chain->Add("/home/Koishi/Projects/kc2023/DiLc/feeddown/Bd2LcLcKS0/Bd2LcLcKS0_Sim.root/DecayTree");
   ...
   params->writeToFile("params_Bd2LcLcKS0.txt");
   ...
   //************************* sweight ***************************
   TFile* file = new TFile("Bd2LcLcKS0_sw.root","recreate"); 
