void drawCMass()
{
  ...
  chain->AddFile("/home/Koishi/Projects/kc2023/DiLc/feeddown/Bd2LcLcKS0/Bd2LcLcKS0_sw.root");
  ...
  MyCan->Print("Bd2LcLcKS0.png");
  MyCan->Print("Bd2LcLcKS0.pdf");
  MyCan->Print("Bd2LcLcKS0.eps");
}
