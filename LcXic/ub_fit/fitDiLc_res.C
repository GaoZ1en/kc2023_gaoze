...
void fitDiLc_res()
{
   ...
   chain->AddFile("/home/Koishi/DiLc/ub_fit/XiccTuple_sw_corrected.root");

   RooRealVar *m = new RooRealVar("C_M_corrected","M(#Lambda_{c}^{+}#bar{#Lambda_{c}^{#minus}})",4575,6075,"MeV/c^{2}");
   RooRealVar *nsig_sw = new RooRealVar("nsig_sw","signal weight",-0.6,1.4);
   ...
   RooRealVar *width3 = new RooRealVar("#width3","width3",107.4,50,150);
   ...
   RooRealVar *width4 = new RooRealVar("#width4","width4",68.78,0,100);
   ...
   RooRealVar *width5 = new RooRealVar("#width5","width5",44.93,0,100);
   ...
   RooRealVar *width7 = new RooRealVar("#width7","width7",137.6,0,200);
